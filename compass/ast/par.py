...
class Par(Statement):
    """
    Class used to represent the parallel execution of several Statements in
    the AST.
    """

    def __init__(self, list_statement: List[Statement]):
        """
        Constructor of the Par class.

        Arguments
        =========
         - list_statement: The list of Statements to build this Par from.
        """
