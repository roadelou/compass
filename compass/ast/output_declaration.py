...
class OutputDeclaration(Declaration):
    """
    Class used to represent the declaration of an output Signal in the AST.
    """

    def __init__(self, signal: Signal):
        """
        Constructor of the OutputDeclaration class.

        Arguments
        =========
         - signal: The Signal which will be treated as an output to the module.
        """
